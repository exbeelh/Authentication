    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    nik = table.Column<string>(type: "varchar(5)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    account_nik = table.Column<string>(type: "varchar(5)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_M_Account_Roles_TB_M_Accounts_account_nik",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_M_Account_Roles_account_nik",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_M_Employees_email_phone",
